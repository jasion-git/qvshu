...
import com.hishu.vacation.common.CommonUtils;
...
public class LogAop implements Ordered{
	...
	@AfterReturning(value="@annotation(com.hishu.vacation.annotation.Log)", returning = "returnVal")
    public void afterReturin(Object returnVal){
		log.debug("------------------------正常结束---------------------------");
		log(0);
    }
	@AfterThrowing(value="@annotation(com.hishu.vacation.annotation.Log)", throwing = "e")
	...
	private void log(Integer errorCode){
		...
		//人物：获取用户信息
		AdminUser userInSession=(AdminUser) request.getSession().getAttribute(Constant.USER_SESSION_KEY);
